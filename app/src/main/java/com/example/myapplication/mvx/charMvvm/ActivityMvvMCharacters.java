...
public class ActivityMvvMCharacters extends AppCompatActivity  implements  MvpCharacter.View{
    ...
    private  ViewModelCharacters viewModelCharacters;
...
//        presenter = new PresenterCharacter(this);
        viewModelCharacters = ViewModelProviders.of(this).get(ViewModelCharacters.class);
        observeViewModel();

    }
    private void observeViewModel() {
        viewModelCharacters.getResult().observe(this, result ->{
            updateViews(result.getResults());
        });
    }
    ...
    public static Intent getIntent(Context context) {
        return  new Intent(context, ActivityMvvMCharacters.class);
    }
